...
const DOODLES = [
  { c: '7 + 5 = 12', top: '11%', left: '6%', size: 34, color: 'var(--sf-yellow)', rot: -6, delay: '0s' },
  { c: 'a² + b² = c²', top: '72%', left: '4%', size: 32, color: 'var(--sf-sky)', rot: 4, delay: '1.2s' },
  { c: '√144 = 12', top: '20%', left: '82%', size: 32, color: 'var(--sf-pink)', rot: 5, delay: '0.6s' },
  { c: 'π ≈ 3.14', top: '80%', left: '80%', size: 36, color: 'var(--sf-teal)', rot: -4, delay: '2s' },
  { c: '∑ⁿ', top: '44%', left: '92%', size: 44, color: 'var(--sf-emerald)', rot: -8, delay: '1.6s' },
  { c: '9 × 8 = 72', top: '50%', left: '2%', size: 30, color: 'var(--sf-purple)', rot: 6, delay: '0.3s' },
  { c: '÷', top: '6%', left: '50%', size: 56, color: 'var(--sf-pink)', rot: -10, delay: '2.4s' },
  { c: '½ + ¼', top: '90%', left: '44%', size: 34, color: 'var(--sf-yellow)', rot: 3, delay: '0.9s' },
];
    ...
    <div className="hidden flex-col gap-7 sf-fade-up lg:flex">
      ...
      <div className="flex flex-col gap-5 pr-6">
        <div className="flex items-end justify-between gap-4">
          ...
          <span className="pb-1 text-lg font-extrabold" style={{ color: 'var(--sf-faint)' }}>vs</span>
        ...
        <p className="mt-1 text-6xl font-extrabold" style={{ fontFamily: 'var(--font-chalk-display)' }}>
          7 + 5 ={' '}
          <span style={{ color: 'var(--sf-yellow)', borderBottom: '3px solid var(--sf-yellow)', padding: '0 10px' }}>
            ?
          </span>
        </p>
