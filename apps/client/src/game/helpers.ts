...
export function inferPlayerSlot(snapshot: GameSnapshot | null, playerId: string): GameSlot | undefined {
...
export function avatarFor(combatant: GameCombatant, players: Record<string, PlayerPresentation> | undefined): string {
...
export function winnerText(t: (key: TranslationKey) => string, summary: GameSummary, playerId: string): string {
...
export function matchEndDetail(t: (key: TranslationKey) => string, summary: GameSummary, playerId: string, players?: Record<string, PlayerPresentation>): string {
  if (summary.status === "voided") {
...
export function outcomeMessage(t: (key: TranslationKey) => string, event: GameEvent, playerSlot?: GameSlot): string {
