...
Supporting documentation for **Exponent — ft_transcendence**.

For project overview, setup, tech stack, database schema, features, and modules, see the [main README](../README.md).
