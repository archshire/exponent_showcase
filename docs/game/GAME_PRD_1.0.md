...
| --- | --- | --- |
| Game PRD summary | `docs/game/GAME_PRD_1.0.md` | All teammates reference this first. |
| Detailed game rules | `docs/game/GAME_LOGIC.md` | Game implementation and agents. |
| Constitutional state | `docs/game/K_GAME_PRD_1.0_CONSTITUTIONAL_STATE.md` | Deep traceable source of stabilized intent. |
| Constitutional journal | `docs/game/K_GAME_PRD_1.0_CONSTITUTIONAL_JOURNAL.md` | History of clarification and rationale. |
